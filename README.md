...
In this version of the code, the fixed wind UAV is requested to follow a line. The controllers are in discrete time, but the output signals are reported in continuous time.  
